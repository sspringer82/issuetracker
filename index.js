...
app.get('/edit', require('connect-ensure-login').ensureLoggedIn(), (req, res) => {
});
app.get('/new', require('connect-ensure-login').ensureLoggedIn(), (req, res) => {
...
app.post('/issue', require('connect-ensure-login').ensureLoggedIn(), (req, res) => {
});
app.get('/remove/:id', require('connect-ensure-login').ensureLoggedIn(), (req, res) => {
